...
final int     squiggle_length = 300;    // Too small will fry your servo
final int     half_radius = 20;          // How grundgy
final int     adjustbrightness = 13;     // How fast it moves from dark to light, over draw
final float   sharpie_dry_out = 0.25;   // Simulate the death of sharpie, zero for super sharpie
final String  pic_path = "pics/john.jpg";
