...
#define MAX_FEEDRATE    (2.0) // changed from 3500
...
#define SERVO_PIN2      (9)
#define SERVO_PIN       SERVO_PIN2  // switch if you want to use the other pin.  Thanks, Aleksey!
...
#define M1_ONESTEP(x)  m1.step(1,x) // 3 = interleave
...
static void FindHome() {
  ...
  do {
    M1_STEP(1,M1_REEL_IN , 4);
    M2_STEP(1,M2_REEL_OUT, 4);
